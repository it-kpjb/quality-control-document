...
class PermissionModel extends Model
{
    ...
    // public function getPermissionsForUserAndFilter(int $userId): array
    // {
    //     // $flag = false;
    //     if (null === $found = cache("{$userId}_permissions")) {
    //         $fromUser = $this->db->table('auth_users_permissions')
    ...
    //             ->join('auth_permissions', 'auth_permissions.id = auth_groups_permissions.permission_id', 'inner')
    //             ->where('user_id', $userId)
    //             // ->like('auth_permissions.name', $group)
    //             // ->like('auth_permissions.name', 'qcdoc')
    //             ->get()
    //             ->getResultObject();
    ...
    // public function getPermissionsForUserAndFilterSidebar(int $userId, string $group)
    // {
    //     $flag = false;
    //     if (null === $found = cache("{$userId}_permissions")) {
    //         $fromUser = $this->db->table('auth_users_permissions')
