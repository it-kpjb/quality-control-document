...
class GroupModel extends Model
{
     ...
     * @return mixed
     */
    public function addPermissionToGroup(int $permissionId, int $groupId, int $userId)
    {
        cache()->delete("{$userId}_permissions");
        $data = [
     ...
     * @return mixed
     */
    public function removePermissionFromGroup(int $permissionId, int $groupId, int $userId)
    {
        cache()->delete("{$userId}_permissions");
