...
class User extends Entity
{
    ...
    // public function getPermissionsAndFilter($name)
    // {
    //     if (empty($this->id)) {
    //         throw new RuntimeException('Users must be created before getting permissions.');
    //     }
    ...
    //     if (empty($this->permissions)) {
    //         $this->permissions = model(PermissionModel::class)->getPermissionsForUserAndFilter($this->id);
    //     }

    //     return $this->permissions;
    // }
    // public function getPermissionsAndFilterSidebar($group)
    // {
    //     if (empty($this->id)) {
    //         throw new RuntimeException('Users must be created before getting permissions.');
    //     }
    ...
    //     if (empty($this->permissions)) {
    //         $this->permissions = model(PermissionModel::class)->getPermissionsForUserAndFilterSidebar($this->id, $group);
    //     }

    //     $flag = (in_array($group, $this->permissions));
